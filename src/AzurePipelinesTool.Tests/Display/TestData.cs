...
internal static class TestData
{
    ...
    public static IReadOnlyList<LocalPipelineInfo> SamplePipelines =>
        [
            CreatePipeline(
                "docker-tools-imagebuilder-official",
                367,
                "eng/pipelines/dotnet-buildtools-image-builder-official.yml"
            ),
            CreatePipeline(
                "docker-tools-imagebuilder-unofficial",
                1513,
                "eng/pipelines/dotnet-buildtools-image-builder-unofficial.yml"
            ),
            CreatePipeline("push-common-updates", 630, "eng/pipelines/push-common-updates.yml"),
            CreatePipeline("dotnet-docker-tools-cg-detection", 964, "eng/pipelines/cg-detection.yml"),
        ];
    ...
    /// </summary>
    public static AzurePipelinesTool.Display.PipelineInfoView SamplePipelineInfoView =>
        new()
        {
            ...
            Variables = SampleVariables.Select(AzurePipelinesTool.Display.VariableRowView.From).ToList(),
            Parameters = SampleParameters.Select(AzurePipelinesTool.Display.ParameterRowView.From).ToList(),
        };
    ...
    /// </summary>
    public static BuildTimelineInfo SucceededTimeline =>
        new(
            [
                new TimelineStageInfo(
                    "Build",
    ...
    /// </summary>
    public static BuildTimelineInfo FailedTimeline =>
        new(
            [
                new TimelineStageInfo(
                    "Build",
    ...
    /// </summary>
    public static BuildTimelineInfo InProgressTimeline =>
        new(
            [
                new TimelineStageInfo(
                    "Build",
    ...
    private static LocalPipelineInfo CreatePipeline(string name, int id, string relativePath) =>
        new(
            Name: name,
