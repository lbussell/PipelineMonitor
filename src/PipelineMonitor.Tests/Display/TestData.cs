...
internal static class TestData
{
    ...
    /// </summary>
    public static PipelineMonitor.Display.PipelineInfoView SamplePipelineInfoView => new()
    {
        ...
        Variables = SampleVariables
            .Select(PipelineMonitor.Display.VariableRowView.From)
            .ToList(),
        Parameters = SampleParameters
            .Select(PipelineMonitor.Display.ParameterRowView.From)
            .ToList(),
    };
